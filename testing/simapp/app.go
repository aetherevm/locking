...
import (
	...
	locking "github.com/aetherevm/locking/locking"
	lockingkeeper "github.com/aetherevm/locking/locking/keeper"
	lockingtypes "github.com/aetherevm/locking/locking/types"
	...
	simappparams "github.com/aetherevm/locking/testing/simapp/params"
...
var (
	...
	maccPerms = map[string][]string{
		...
		nft.ModuleName:                 nil,
		lockingtypes.ModuleName:        {authtypes.Minter, authtypes.Staking},
	}
)
...
func NewSimApp(
	...
	// We must set the lockgin keeper before setting the staking hooks
	app.LockingKeeper = lockingkeeper.NewKeeper(
		keys[lockingtypes.StoreKey], appCodec,
	...
	// register the distribution rewards hooks
	// this must be done before we set the staking hooks
	app.DistrKeeper.SetHooks(
		distrtypes.NewMultiDistributionHooks(
			app.LockingKeeper.DistributionHooks(),
		),
	)
	...
	app.StakingKeeper.SetHooks(
		stakingtypes.NewMultiStakingHooks(
			...
			app.LockingKeeper.StakingHooks(),
		),
	)

	// Override the staking and distribution keeper with a new one carring the hooks
	app.LockingKeeper.SetStakingKeeper(app.StakingKeeper)
	app.LockingKeeper.SetDistributionKeeper(app.DistrKeeper)
	...
	*/
	...
	app.ModuleManager = module.NewManager(
		...
		locking.NewAppModule(appCodec, app.LockingKeeper),
	)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(lockingtypes.ModuleName)
